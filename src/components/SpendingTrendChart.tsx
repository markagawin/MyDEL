...
export default function SpendingTrendChart({ points }: Props) {
  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.subtitle}>Total outflow across your last {points.length} pay cycles</Text>
...
const createStyles = (theme: AppTheme) =>
  StyleSheet.create({
    ...
    subtitle: { fontSize: 11.5, color: theme.textMuted, marginTop: 2, marginBottom: 14 },
    chartRow: {
      flexDirection: 'row',
      alignItems: 'flex-end',
